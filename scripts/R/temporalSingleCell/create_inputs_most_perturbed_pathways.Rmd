...
inputGraphs <- list()
for (cellType in cellTypes){
  inputGraphs[[cellType]] <- createInputGraphWithResource(rankedPathwaysPerCellType, metaPathwayEdges, pathwayMap, cellType)
  write.table(inputGraphs[[cellType]], file = paste0("/home/josura/Projects/ccc/datiIdo/inputGraphs/1h/graphsWithLR/",cellType,".tsv"), sep = "\t", row.names = FALSE)
}
```
