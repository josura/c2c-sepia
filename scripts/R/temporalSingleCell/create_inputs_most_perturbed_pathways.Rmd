...
for (cellType in cellTypes){
  inputGraph <- createInputGraph(rankedPathwaysPerCellType, metaPathwayEdges, pathwayMap, cellType)
  write.table(inputGraph, file = paste0("/home/josura/Projects/ccc/datiIdo/inputGraphs/1h/",cellType,".tsv"), sep = "\t", row.names = FALSE)
}
```
