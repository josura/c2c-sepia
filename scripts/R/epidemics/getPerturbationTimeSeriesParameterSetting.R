...
outputsFolder <- "/home/josura/Projects/ccc/c2c-sepia/outputs/leonardo_scratch/fast/CNHPC_1452526/epidemics/parameterSetting/"
outputsTimeSeriesFolder <- "~/Projects/ccc/c2c-sepia/outputsTimeSeries/parameterSetting/"
