...
for celltype in celltypes:
    ...
    for row in moduleInfoTransformed.iterrows():
        ...
        for gene in genes:
            moduleInfluence = pd.concat(moduleInfluence, pd.{"StartType":startType, "StartNodeName":gene, "EndType":endType, "EndNodeName":row[1]["Start"], "Weight":1}, ignore_index=True)
